...
class TestPublishInAfterEffects(AELocalPublishTestClass):
    """Basic test case for publishing in AfterEffects
        ...
        Contains non standard project dump, with frames 1001-1001!!!
        (Default is 1001-1010)
    """
    PERSIST = False

    TEST_FILES = [
        ("resources/test_publish_in_aftereffects.zip",
         "test_publish_in_aftereffects.zip",
         "")
    ]
